...
### R009 — `fetchEncryptedAssetsBatch` accepts `{ address, contentId, revision }[]` tuples and returns matching encrypted assets in one Hasura round trip
- Class: core-capability
- Status: active
...
### R010 — Full `EncryptedAssetInclude` type narrowing on batch results
- Class: quality-attribute
- Status: active
...
### R011 — `useEncryptedAssetsBatch` React and Next.js hooks
- Class: core-capability
- Status: active
...
### R012 — Docs updated with batch function, hooks, and params
- Class: quality-attribute
- Status: active
...
### R013 — Changeset for minor release of types, node, react, next
- Class: quality-attribute
- Status: active
...
### R014 — All 5 packages compile with zero errors
- Class: quality-attribute
- Status: active
...
| R009 | core-capability | active | M005/S01 | none | unmapped |
| R010 | quality-attribute | active | M005/S01 | none | unmapped |
| R011 | core-capability | active | M005/S01 | none | unmapped |
