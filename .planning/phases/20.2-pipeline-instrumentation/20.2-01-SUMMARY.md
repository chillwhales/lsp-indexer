...
plan: 01
subsystem: infra
tags: [performance, logging, pipeline, instrumentation, pino]

# Dependency graph
requires:
  - phase: 20.1-structured-logging-overhaul
    provides: createStepLogger infrastructure and PipelineStep type union
provides:
...
tech-stack:
  added: []
  patterns: [step-timing-wrap-pattern, batch-summary-log]
