...
plan: 02
subsystem: release
tags: [changeset, versioning, npm, minor-bump, consumer-packages]

# Dependency graph
requires:
  - phase: 21-sorting-consumer-package-release
    provides: Sorting changes across all 12 domain types and services (Plan 01)
provides:
...
tech-stack:
  added: []
  patterns: [changesets-fixed-group-versioning]
...
requirements-completed: [RELP-01]
