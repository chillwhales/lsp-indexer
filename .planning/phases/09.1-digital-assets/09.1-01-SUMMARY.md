...
plan: '01'
name: 'digital-asset-types-codegen'
subsystem: 'types-and-codegen'
tags: ['zod', 'typescript', 'graphql', 'codegen', 'digital-assets', 'lsp7', 'lsp8']

dependency-graph:
  requires: ['08-profiles']
  provides:
    ['digital-asset-zod-schemas', 'digital-asset-graphql-documents', 'digital-asset-codegen']
...
decisions:
  - 'SortDirectionSchema moved to common.ts as shared schema, profiles.ts re-exports for backward compat'
  - 'TokenTypeSchema uses clean enum TOKEN/NFT/COLLECTION (no raw 0/1/2 strings)'
  - 'DigitalAssetIncludeSchema uses inverted default — omit include = fetch everything'
  - 'Standard field (LSP7/LSP8) included in DigitalAssetSchema for parser to populate'
  - 'LSP8-specific fields (referenceContract, tokenIdFormat, baseUri) as nullable on DigitalAssetSchema'
  - 'lsp4CreatorsLength.value used for creatorCount (numeric field)'
  - 'ownedAssets_aggregate used for holderCount'
