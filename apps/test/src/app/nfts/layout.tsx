...
/**
 * Force dynamic rendering for the NFTs playground.
 *
 * NFT hooks call `getClientUrl()` at initialization which reads
...
export default function NftsLayout({ children }: { children: ReactNode }): ReactNode {
  return children;
}
