...
```bash
npm install @lsp-indexer/react @lsp-indexer/types @lsp-indexer/node @tanstack/react-query
```
...
| Follows               | `useFollows`, `useInfiniteFollows`, `useFollowCount`, `useIsFollowing`, `useFollowSubscription`                                                    |
