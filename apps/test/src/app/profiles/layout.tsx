...
/**
 * Force dynamic rendering for the profiles playground.
 *
 * Profile hooks call `getClientUrl()` at initialization which reads
...
export default function ProfilesLayout({ children }: { children: ReactNode }): ReactNode {
  return children;
}
