...
It does **not** yet include verified domain reducers, metadata workers, applied Hasura metadata, or
the v3 consumer package contracts. Those land in subsequent v3 goals and the v2 implementation
...
Run one network's raw event pipe after database migration and readiness checks:
