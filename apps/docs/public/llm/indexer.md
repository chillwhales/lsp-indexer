...
It does **not** yet include the v3 consumer package contracts or production acceptance. Those land
...
being overwritten.
The raw schema is the input to the upcoming v3 package code generation; the public v2 packages do
not consume it yet.
