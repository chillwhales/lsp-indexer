...
Unexpected API relations or routines abort migration, and the API reader receives schema access and
`SELECT` only after that inventory check, limited to the enumerated public views.
