...
| `METADATA_LEASE_TIMEOUT_MS`             | Crash-recovery lease; defaults to `300000` milliseconds          |
| `METADATA_METRICS_PORT`                 | Worker metrics port; defaults to `9091`                           |
| `METADATA_IPFS_GATEWAY`                 | Override the selected network's configured IPFS gateway          |
