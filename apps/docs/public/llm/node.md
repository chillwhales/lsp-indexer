...
lossless, and deterministic chain/id suffixes are appended to every sort.
...
behavior and prevents malformed hexadecimal input from silently broadening a request.
...
transaction provenance. Metadata source revisions are canonical 32-byte hashes.
