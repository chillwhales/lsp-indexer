...
`chillwhales_nfts` is currently a LUKSO Mainnet-only v3 alpha projection. A public Node fetch
contract is intentionally unavailable until the v3 package-contract goal lands.
