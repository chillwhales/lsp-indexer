 ...
 *
 * The multicall address is passed as a parameter so it can be sourced
 * from ChainConfig instead of hardcoded constants.
 */
 ...
 * @param multicallAddress - Multicall3 contract address for this chain
