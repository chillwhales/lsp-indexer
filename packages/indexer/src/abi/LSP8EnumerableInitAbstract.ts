...
export const functions = {
    ...
    tokenAt: viewFun("0x92a91a3a", "tokenAt(uint256)", {"index": p.uint256}, p.bytes32),
...
export class Contract extends ContractBase {
    ...
    tokenAt(index: TokenAtParams["index"]) {
        return this.eth_call(functions.tokenAt, {index})
    }
...
export type TokenAtParams = FunctionArguments<typeof functions.tokenAt>
export type TokenAtReturn = FunctionReturn<typeof functions.tokenAt>
