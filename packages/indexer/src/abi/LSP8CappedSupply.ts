...
export const functions = {
    ...
    tokenSupplyCap: viewFun("0x52058d8a", "tokenSupplyCap()", {}, p.uint256),
...
export class Contract extends ContractBase {
    ...
    tokenSupplyCap() {
        return this.eth_call(functions.tokenSupplyCap, {})
    }
...
export type TokenSupplyCapParams = FunctionArguments<typeof functions.tokenSupplyCap>
export type TokenSupplyCapReturn = FunctionReturn<typeof functions.tokenSupplyCap>
