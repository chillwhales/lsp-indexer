...
export const functions = {
    ...
    claimChill: fun("0x7d1b611f", "claimChill(bytes32,bytes)", {"tokenId": p.bytes32, "data": p.bytes}, ),
    claimChillBatch: fun("0x9c644656", "claimChillBatch(bytes)", {"data": p.bytes}, ),
    decimals: viewFun("0x313ce567", "decimals()", {}, p.uint8),
    decreaseAllowance: fun("0x7b204c4e", "decreaseAllowance(address,uint256,bytes)", {"operator": p.address, "subtractedAmount": p.uint256, "operatorNotificationData": p.bytes}, ),
    getClaimedStatusFor: viewFun("0xb1111e64", "getClaimedStatusFor(bytes32)", {"tokenId": p.bytes32}, p.bool),
    ...
    getUnclaimedTokenIdsForAddress: viewFun("0x65e72335", "getUnclaimedTokenIdsForAddress(address)", {"holder": p.address}, p.array(p.bytes32)),
    ...
    revokeOperator: fun("0x4521748e", "revokeOperator(address,bool,bytes)", {"operator": p.address, "notify": p.bool, "operatorNotificationData": p.bytes}, ),
...
export class Contract extends ContractBase {
    ...
    getClaimedStatusFor(tokenId: GetClaimedStatusForParams["tokenId"]) {
        return this.eth_call(functions.getClaimedStatusFor, {tokenId})
    }
    ...
    getUnclaimedTokenIdsForAddress(holder: GetUnclaimedTokenIdsForAddressParams["holder"]) {
        return this.eth_call(functions.getUnclaimedTokenIdsForAddress, {holder})
    }
...
export type ClaimChillParams = FunctionArguments<typeof functions.claimChill>
export type ClaimChillReturn = FunctionReturn<typeof functions.claimChill>

export type ClaimChillBatchParams = FunctionArguments<typeof functions.claimChillBatch>
export type ClaimChillBatchReturn = FunctionReturn<typeof functions.claimChillBatch>
...
export type GetClaimedStatusForParams = FunctionArguments<typeof functions.getClaimedStatusFor>
export type GetClaimedStatusForReturn = FunctionReturn<typeof functions.getClaimedStatusFor>
...
export type GetUnclaimedTokenIdsForAddressParams = FunctionArguments<typeof functions.getUnclaimedTokenIdsForAddress>
export type GetUnclaimedTokenIdsForAddressReturn = FunctionReturn<typeof functions.getUnclaimedTokenIdsForAddress>
