 ...
 *
 * Merges into existing LSP12IssuedAsset entity if one exists in EITHER
...
function extractFromIndex(
  ...
  event: DataChanged,
  hctx: HandlerContext,
  existingAssets: Map<string, LSP12IssuedAsset>,
): void {
  ...
  existingAssets.set(id, entity); // Add to map for subsequent events
