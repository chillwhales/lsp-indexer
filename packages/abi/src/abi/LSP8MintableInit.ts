...
export const functions = {
    ...
    initialize: fun("0x74823132", "initialize(string,string,address,uint256,uint256)", {"name_": p.string, "symbol_": p.string, "newOwner_": p.address, "lsp4TokenType_": p.uint256, "lsp8TokenIdFormat_": p.uint256}, ),
    isOperatorFor: viewFun("0x2a3654a4", "isOperatorFor(address,bytes32)", {"operator": p.address, "tokenId": p.bytes32}, p.bool),
    mint: fun("0xaf255b61", "mint(address,bytes32,bool,bytes)", {"to": p.address, "tokenId": p.bytes32, "force": p.bool, "data": p.bytes}, ),
