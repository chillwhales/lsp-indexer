 ...
 *
 * Mirrors `GetOwnedAssetsDocument` field selections and `@include` directives exactly.
 * Differences from query: `subscription` keyword, no `$offset`, no `_aggregate` (top-level).
 */
export const OwnedAssetSubscriptionDocument = `
