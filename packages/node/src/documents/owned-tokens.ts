...
export const GetOwnedTokenDocument = graphql(`
  query GetOwnedToken(
    ...
    $includeNftScore: Boolean! = false
    $includeNftRank: Boolean! = false
    $includeNftChillClaimed: Boolean! = false
    $includeNftOrbsClaimed: Boolean! = false
    $includeNftLevel: Boolean! = false
    $includeNftCooldownExpiry: Boolean! = false
    $includeNftFaction: Boolean! = false
