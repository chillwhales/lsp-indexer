...
/**
 * GraphQL subscription document for real-time universal receiver event updates.
 *
 * Mirrors `GetUniversalReceiverEventsDocument` field selections and `@include` directives exactly.
 * Differences from query: `subscription` keyword, no `$offset`, no `_aggregate`.
 */
export const UniversalReceiverEventSubscriptionDocument = `
