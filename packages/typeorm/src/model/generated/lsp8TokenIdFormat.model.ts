...
import {LSP8TokenIdFormatEnum} from "./_lsp8TokenIdFormatEnum"

@Index_(["blockNumber", "transactionIndex", "logIndex"], {unique: false})
@Entity_()
export class LSP8TokenIdFormat {
    constructor(props?: Partial<LSP8TokenIdFormat>) {
    ...
    value!: LSP8TokenIdFormatEnum | undefined | null
